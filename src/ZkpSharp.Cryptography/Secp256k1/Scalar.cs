...
namespace ZkpSharp.Cryptography.Secp256k1
{
    /// <summary>
    ...
    public readonly struct Scalar : IEquatable<Scalar>
    {
        ...
        public static Scalar operator +(Scalar a, Scalar b) => new(a._value + b._value);
        public static Scalar operator -(Scalar a, Scalar b) => new(a._value - b._value);
        public static Scalar operator -(Scalar a) => new(a.IsZero ? BigInteger.Zero : N - a._value);
        public static Scalar operator *(Scalar a, Scalar b) => new(a._value * b._value);
        ...
        public Scalar Pow(BigInteger exponent) => new(BigInteger.ModPow(_value, exponent, N));
