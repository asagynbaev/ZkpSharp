...
///   <item><c>info</c> = <c>"Tessera/v1/channel-bind"</c> (domain separator across SDK uses)</item>
...
{
    private static readonly byte[] HkdfInfo = Encoding.UTF8.GetBytes("Tessera/v1/channel-bind");
